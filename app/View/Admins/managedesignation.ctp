...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Manage Designation<small> You can add, edit </small>
        </h3>
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <a href="<?php echo Router::url(array('controller' => 'admins', 'action' => 'adddesignation')) ?>" title="Add new admin" class="fa fa-plus">
                            </a>
...
<!--                                                        <a tiMovie Name:tle="Click here for individual data update :-)" href="#product-pop-up" class="fancybox-fast-view" style="overflow: -webkit-paged-x;">
                                    ...
                                    <div class="row">
                                        <div class="controls center text-center">                                              
                                            ...
                                            echo $this->Form->create('Designation', array(
                                                ...
                                                'url' => array('controller' => 'admins', 'action' => 'adddesignation')
                                                    )
                                            );
                                            ?>
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">  Designation Name:<span class="required">
                                                            * </span>
                                                    </label>
                                                    <div class="col-md-4">
                                                        <?php
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                            ...
                            <tbody>
                                <?php
                                foreach ($designations as $single):
                                    ...
                                    <tr >
                                        ...
                                        <td>   
                                            <div class="controls center text-center">
                                                <a title="edit" href="<?php echo Router::url(array('controller' => 'admins', 'action' => 'editdesignation', $designation['id'])) ?>" >
