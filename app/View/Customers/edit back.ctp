...
<?php
$btn = '';
if (strtolower($status) == 'canceled' || strtolower($status) == 'hold') {
    $btn = "disabled";
}
?>
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            Balance : $<strong class="due-amount">
                                ...
                                <?php
                                if (!empty($customer_info['PackageCustomer']['status'])) {
                                    echo $customer_info['PackageCustomer']['status'];
                                }
                                ?>
...
//                                            'readonly' => 'readonly',
                                ...
                                <div class="row margin-top-20">
                                    <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20"> 
                                        <?php
                                        echo $this->Form->button(
                                                'Update Mac Information', array('class' => 'btn btn-primary submitbtn red-soft', 'type' => 'submit')
                                        );
                                        ?>
                                    </div>
                                </div>                            
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <?php if (($user == 'sadmin') || ($user == 'supervisor')): ?>
                                                        ...
                                                        <a  target="_blank" title="Edit" href="<?php echo Router::url(array('controller' => 'transactions', 'action' => 'edit', $this->request->params['pass'][0], $info['transactions']['id'])) ?>" >
...
//                                                echo '<hr>';
                                            ...
                                            <li>
                                                Invoice Date : 
                                                <?php echo date('m-d-Y', strtotime($bill['created'])); ?>
