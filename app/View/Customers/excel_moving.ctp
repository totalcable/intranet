            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <b style="color: white;">Moving (Search data by date) </b>                             
                        </div>
                        <div class="tools">
...
//                                        exit;
                                        ...
                                        <tr>  
                                            <td class="hidden-480">
                                                <?php
//                                                if ($results['ins']['date']='0000-00-00' ) {
//                                                    echo date('m-d-Y', strtotime($results['ins']['schedule_date']));
//                                                } else {
                                                    echo date('m-d-Y', strtotime($results['ins']['date']));                                                    
//                                                }
                                                ?> <br>
