                            ...
                            <ul class="pagination" >
                                ...
                                for ($i = 1; $i <= $total_page; $i++):
                                    ...
                                    <li class="paginate_button <?php echo $active; ?>" aria-controls="sample_editable_1" tabindex="<?php echo $i; ?>">
                                        <a href="<?php echo Router::url(array('controller' => 'customers', 'action' => 'excel_sheet', $i)) ?>"><?php echo $i; ?></a>
                                    </li>
                                <?php endfor; ?>
                            </ul>
...
<!--                                        <th>
                                    ...
                                    foreach ($filteredData as $results):
                                       // pr($results);
                                        ...
                                        $customer_address = $customer['house_no'] . ' ' . $customer['street'] . ' ' .
                                                ...
                                                . $customer['zip'];
                                        ?>
                                        <?php if ($customer['shipment'] == 1 AND $customer['follow_up'] == 0 AND $customer['status'] == 'requested') { ?>
                                            <?php $tt = 'This is shipment data' ?>
                                            <?php $ff = 'turquoise'; ?>

                                        <?php } else if ($customer['follow_up'] == 0 AND $customer['status'] == 'done') { ?>
                                            <?php $ff = 'lightskyblue'; ?>
                                            <?php $tt = 'This is followup data' ?> 

                                        <?php } else if ($customer['shipment'] == 0 AND $customer['follow_up'] == 0 AND $customer['status'] == 'requested' AND $customer['dealer'] != '') { ?> 
                                            <?php $ff = 'tan'; ?>
                                            <?php $tt = 'This is dealer data' ?>
                                        <?php } else { ?>
                                            <?php $ff = 'None'; ?>
                                            <?php $tt = 'This is not shipment, followup & dealer data' ?>
                                        <?php } ?>      

                                        <tr  title="<?php echo $tt ?>" style="background-color: <?php echo $ff; ?>">  
                                            <td >
                                                <?php echo $customer['id']; ?>
                                            </td> 

                                            <td >
                                                <?php echo date('m-d-Y', strtotime($customer['date'])); ?> <br>
    ...
    <!--                                            <td>                                              
                                                <b>Technician comment:</b> <?php echo $customer['status']; ?></b> 
                                            </td>-->
                                            <td>
                                                <?php if (!empty($customer['tech_comments'])) { ?> 
                                                    <b>Tech comment: </b><?php echo $customer['tech_comments']; ?>  
                                                <?php } ?> 

                                            </td>
                                            <td>
                                                <div class="controls center text-center">
                                                    <?php if ($customer['post_pone'] != 1) { ?>
                                                        <a href="#" title="Forward">
                                                            <span id="<?php echo $customer['id']; ?>" class="fa fa-mail-forward fa-lg forward_ticket"></span>
                                                        </a>
                                                    <?php } ?>

                                                    <?php if ($customer['post_pone'] != 0) { ?>
                                                        &nbsp;
                                                    ...
                                                    <a href="#" title="Comment">
                                                        <span id="<?php echo $customer['id']; ?>" class="fa fa-remove fa-lg comment_ticket"></span>
                                                    </a>    
                                                    <!--                                                    &nbsp;
                                                                                                        <a href="#" title="Comment">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    echo $this->Form->input('comment', array(
                                                                        ...
                                                                        'placeholder' => 'Write your comments about cancel'
                                                                            )
                                                                    );
                                                                    ?>
                                                                </div>
