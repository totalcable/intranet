                    ...
                    <td>
                        <ul>
                            <li> Name: <a href="<?php
                                ...
                                ?>" 
                                          target="_blank"><?php echo $customer['first_name'] . ' ' . $customer['middle_name'] . ' ' . $customer['last_name']; ?></a> </li> 
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    echo $this->Form->input('comment', array(
                                                        ...
                                                        'placeholder' => 'Write your comments about solve'
                                                            )
                                                    );
                                                    ?>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    echo $this->Form->input('comment', array(
                                                        'type' => 'textarea',
                                                        'class' => 'form-control required txtArea',
                                                        'placeholder' => 'Write your comments about unresolved'
                                                            )
                                                    );
                                                    ?>
                                                </div>
