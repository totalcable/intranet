                                    ...
                                    <td>
                                        ...
                                        <tr>
                                                <td class="wrapper last">
                                                 ...
                                                 <a style="background: green; color: #FFF; padding: 4px 10px; border-radius: 7px;" href="http://<?php echo $_SERVER['HTTP_HOST'].DS.$mail_content['url'].DS.$mail_content['key'] . 'BXX' . $mail_content['rand'] . 'XXB' . $mail_content['id']; ?>/">Click here to reset your account password</a>
                                                 <hr />
                                                 <p>Alternatively, you can also copy paste the below link into your browser:
                                                 </p>
                                                 <p>http://<?php echo $_SERVER['HTTP_HOST'].DS.$mail_content['url'].DS.$mail_content['key'].'BXX' .$mail_content['rand'].'XXB'. $mail_content['id'];?>/</p>
                                                 
                                             </td>
                                             <td>
                                             <p style="font-size:18px; font-weight:bold;">This email was sent by www.jegeachi.com </p>
                                             </td>
                                         </tr>
                                        </table>
