                                    ...
                                    <tr >
                                        ...
                                        <td>   
                                            <div class="controls center">
                                                ...
                                                &nbsp;&nbsp;
                                                <a 
                                                    onclick="if (confirm('Are you sure to cancel this Event?')) {
                                                                        return true;
                                                                    }
                                                                    return false;"

                                                    href="<?php echo Router::url(array('controller' => 'events', 'action' => 'docancel', $event['id'])) ?>" title="cancel">
                                                    <span class="fa  fa-ban"></span>
                                                </a>
                                                <a 
                                                    onclick="if (confirm('Are you sure to close this Event (meaning event done successful)?')) {
                                                                        return true;
                                                                    }
                                                                    return false;"

                                                    href="<?php echo Router::url(array('controller' => 'events', 'action' => 'dodone', $event['id'])) ?>" title="cancel">
