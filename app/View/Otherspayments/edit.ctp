            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus"></i>Modify & Update Others Payment
                        </div>
                        <!--                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <?php
                        echo $this->Form->create('OthersPayment', array(
                            'inputDefaults' => array(
                                'label' => false,
                                'div' => false
                            ),
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Note<span class="required">
                                        * </span>
                                </label>
                                <div class="col-md-4">
                                    <?php
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Technician<span class="required">
                                        * </span>
                                </label>
                                <div class="col-md-4">
                                    <?php
