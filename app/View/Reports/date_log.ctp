            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            Total logs : ( <b style="color: black;" title="Total log"><?php echo $total_date; ?></b> )
                        </div>
                    </div>
                                ...
                                foreach ($data as $single):
                                    ...
                                    <tr >
                                        ...
                                        <td>                                            
                                            ...
                                            <b>Date:</b> <b style="color: green;" title="Your searching key word was (Date wise data)"><?php echo $result['insert_date']; ?></b><br>
                                        </td>                                       
