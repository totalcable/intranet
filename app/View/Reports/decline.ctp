        ...
        $('.nav-toggle').click(function () {
            ...
            $(collapse_content_selector).toggle(function () {
                if ($(this).css('display') == 'none') {
                    ...
                    toggle_switch.html('Card No Show');
                } else {
                    //change the button label to be 'Hide'
                    toggle_switch.html('Card No Hide');
                }
            });
        });
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h3 class="page-title">
            Declined Customers <small></small>
        </h3>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <tbody>
                        <?php
                        foreach ($declineData as $results):
                            $customer = $results['pc'];
                            ...
                            <tr>
                                ...
                                <td class="hidden-480">
                        <li> <?php echo $results['t']['content']; ?> </li>   
                        <li>Date : <?php echo $results['t']['created']; ?> </li>  
                        </td>
                        <td class="hidden-480">
                            <button href=".collapse1<?php echo $customer['id']; ?>" class="nav-toggle">Card No Show</button>
                            <div class="collapse1<?php echo $customer['id']; ?>" style="display:none">
                                ...
                                <li> <b>Status :</b> <?php echo $results['t']['status']  ?></li>

                                </b><?php //echo $results['tr']['pay_mode'];?> </li> 
                                <?php //echo $results['tr']['created']; ?> </li> 
