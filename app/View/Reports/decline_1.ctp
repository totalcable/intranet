            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus"></i>Decline Customers
                        </div>
                        <div class="tools">
                ...
                <div class="col-xs-12">
                    ...
                    <ul class="pagination" >
                        ...
                        for ($i = 1; $i <= $total_page; $i++):
                            ...
                            <li class="paginate_button <?php echo $active; ?>" aria-controls="sample_editable_1" tabindex="<?php echo $i; ?>">
                                <a href="<?php echo Router::url(array('controller' => 'reports', 'action' => 'decline', $i)) ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                    </ul>
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        <tbody>
                            ...
                            <li> <b>Status :</b> <?php echo $results['tr']['status'] ?></li>
