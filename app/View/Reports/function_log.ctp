            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            Total logs : ( <b style="color: black;"><?php echo $total_function;?></b> )
                        </div>
                    </div>
                                ...
                                foreach ($data as $single):
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <b>Function Name:</b> <b style="color: green;" title="Your searching key word was (function wise data)"><?php echo $result['function_name']; ?></b><br>
