            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            Total logs : ( <b style="color: black;" title="Total log"><?php echo $total_pc_name;?></b> )
                        </div>
                    </div>
                                ...
                                foreach ($data as $single):
                                    ...
                                    <tr >
                                        ...
                                        <td>                                            
                                            ...
                                            <b>PC Name:</b> <b style="color: green;" title="Your searching key word was (PC Name wise data)"><?php echo $result['pc_name']; ?></b><br>
