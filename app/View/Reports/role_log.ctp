            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            Total logs : ( <b style="color: black;"><?php echo $total_role;?></b> )
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($data as $single):
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                        <b style="color: green;" title="Your searching key word was (role wise data)"><?php echo $roles['name']; ?></b><br>
                                        </td>  
                                        <td>
