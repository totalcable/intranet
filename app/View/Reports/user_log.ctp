            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            Total logs : ( <b style="color: black;"><?php echo $total_user;?></b> )
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($data as $single):
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                         <b style="color: green;" title="Your searching key word was (user wise data)"><?php echo $users['name']; ?></b><br>
                                        </td> 
