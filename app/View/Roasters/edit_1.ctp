            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus"></i>Edit roaster information
                        </div>
                        <div class="tools">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        <tbody>
                            <?php
                            foreach ($emp_att as $results):
                                $result = $results['roaster_details']
                                ?>
                                <tr>  
                                    ...
                                    <td><b  title="Late time" style="color: green;"><?php
                                            if ($result['extra_time'] != '00:00:00') {
                                                echo $result['extra_time'];
                                            }
                                            ?></b></td>

                                    <td><?php echo $result['total_duty']; ?></td>

                                    <td> <?php echo $result['attend_status']; ?></td>
                                </tr>
                            <?php endforeach; ?> 
                        </tbody>
                    </table>
