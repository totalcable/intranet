                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div style="text-align: center;">
                            ...
                            <div id="product-pop-up" style="overflow: -webkit-paged-x;display: none; height: 675px; width: 900px;">
                                    ...
                                    <div class="product-page product-pop-up">
                                        <div class="row">
                                            <div class="controls center text-center">                                              
                                                ...
                                                <h4 style="color: royalblue;" title="Today is : <?php echo $results['date']; ?> :-)"><?php echo $results['date']; ?></h4>
