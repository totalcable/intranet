            ...
            <div style="text-align: center;">
                ...
                <div class="controls center text-center">   
                    ...
                    echo $this->Form->create('RoasterHistorie', array(
                        ...
                        'class' => 'form-horizontal',
                        'novalidate' => 'novalidate',
                        'url' => array('controller' => 'roasters', 'action' => 'modify_roastermorning')
                            )
                    );
                    ?>
                    <?php
                    ...
                    <div class="controls center text-center"> 
                        <div class="portlet-body" id="package_exp" style="display: none;">
                            ...
                            echo $this->Form->create('RoasterHistorie', array(
                                ...
                                'class' => 'form-horizontal',
                                'novalidate' => 'novalidate',
                                'url' => array('controller' => 'roasters', 'action' => 'modify_roasterafternoon')
                                    )
                            );
                            ?>
                            <?php
                    ...
                    <div class="controls center text-center"> 
                        <div class="portlet-body" id="night" style="display: none;">
                            ...
                            echo $this->Form->create('RoasterHistorie', array(
                                ...
                                'class' => 'form-horizontal',
                                'novalidate' => 'novalidate',
                                'url' => array('controller' => 'roasters', 'action' => 'modify_roasternight')
                                    )
                            );
                            ?>
                            <?php
