                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                            <thead>
                                <tr>  
                                    ...
                                    <th><?php echo 'Shift One'; ?></th> 

                                    <th><?php echo 'Shift Two'; ?></th> 

                                    <th><?php echo 'Shift Three'; ?></th> 

                                    <th><?php echo 'Shift incharge one'; ?></th>

                                    <th><?php echo 'Shift incharge two'; ?></th>

                                    <th><?php echo 'Shift incharge three'; ?></th> 
                                    ...
                                    <th><?php echo 'Agent 4'; ?></th> 

                                    <th><?php echo 'Agent 5'; ?></th> 

                                    <th><?php echo 'Agent 6'; ?></th> 

                                    <th><?php echo 'Agent 7'; ?></th> 

                                    <th><?php echo 'Agent 8'; ?></th> 

                                    <th><?php echo 'Agent 9'; ?></th> 

                                    <th><?php echo 'Agent 10'; ?> </th> 

                                    <th><?php echo 'Agent 11'; ?></th> 
                                </tr>
                            </thead>
                            <tbody>
                                <?php
...
//                                                echo $name_day;
                                            ...
                                            <div id="product-pop-up<?php echo $results['id']; ?>" style="overflow: -webkit-paged-x; display: none; height: auto; width: auto;">
                                                <div class="product-page product-pop-up">
                                                    <div class="row">
                                                        ...
                                                        <h4 style="color: rosybrown; text-align: center;" title="Hello today is : <?php echo $results['date']; ?> :-)"><?php echo $results['date']; ?></h4>
                                        ...
                                        <td class="hidden-480"> <?php echo $results['shift_name_time']; ?> </td>

                                        <td class="hidden-480" > <?php echo $results['afshift_name_time2']; ?> </td>

                                        <td  class="hidden-480"> <?php echo $results['nishift_name_time3']; ?> </td>
