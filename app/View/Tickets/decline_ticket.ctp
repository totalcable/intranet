...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Decline tickets <small>You can resolve, unresolve or froward</small>
        </h3>
...
<!--                        <ul class="pagination" >
                            ...
                            for ($i = 1; $i <= $total_page; $i++):
                                ...
                                <li class="paginate_button <?php echo $active; ?>" aria-controls="sample_editable_1" tabindex="<?php echo $i; ?>">
                                    <a href="<?php echo Router::url(array('controller' => 'tickets', 'action' => 'decline_ticket', $i)) ?>"><?php echo $i; ?></a>
                                </li>
                            <?php endfor; ?>
                        </ul>-->
