...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Package Service Tickets <small>You can resolve, unresolve or froward</small>
        </h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <!--<i class="fa fa-ticket"></i> Tickets is refund bonus... Total tickets: <?php // echo $total_refund_bonus; ?> -->                               
                        </div>
                        <div class="tools">
