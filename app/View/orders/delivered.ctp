...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Delivered Order List <small>Confirm that these orders are recieved by customer</small>
        </h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plane"></i>Delivered Order
                        </div>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                            ...
                            <tbody>
                                ...
                                <strong>    Service Charge : <?php echo $sc; ?></strong> 
                                        ...
                                        <td>
                                            <a 
                                               onclick="if (confirm('Are you sure that it is received?')) {
                                                           return true;
                                                       }
                                                       return false;"

                                               href="<?php
                                               echo Router::url(array('controller' => 'orders', 'action' => 'receive', $order['id'])
                                               )
                                               ?>" class="tip"><span class="fa fa-heart" title="received"></span></a>

                                         &nbsp;&nbsp;&nbsp;
                                            <a 
                                               onclick="if (confirm('Are you sure that it is returned?')) {
                                                           return true;
                                                       }
                                                       return false;"

                                               href="<?php
                                               echo Router::url(array('controller' => 'orders', 'action' => 'back', $order['id'])
                                               )
                                               ?>" class="tip"><span class="fa  fa-exchange" title="back"></span></a>
